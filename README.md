...
🎓Após construir sólidas bases em lógica de programação, HTML, CSS, e Git/Github, tenho evoluído em C#, JavaScript, .NET, PHP e seu ecossistema de tecnologia, sendo algumas delas: SASS, ReactJS, Bootstrap. Também evoluindo bastante em alguns gerenciadores de Banco de dados como MySQL e SQL.
